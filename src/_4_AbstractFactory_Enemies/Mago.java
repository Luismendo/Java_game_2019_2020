...
public abstract class Mago implements Enemigo{
	...
	public void calcularPuntos() {
		...
		int puntosTotales = (int) ((jugador.getFuerza() + jugador.getAgilidad() + jugador.getInteligencia() + jugador.getResistencia() + jugador.getPuntos())*0.8);
		int puntosPrincipales = (int) (puntosTotales *0.8);
		
		
		this.inteligencia = (puntosPrincipales*randomNumBetweenValues(40,60))/100;
